...
export default function Experience() {
  return (
    <section
      id="experience"
      className="relative overflow-hidden bg-black px-4 py-16 text-white sm:px-6 sm:py-24 lg:py-28"
    >
      ...
      <div className="relative mx-auto max-w-7xl">
        <div className="mb-16 text-center">
          <h2 className="text-4xl font-extrabold tracking-normal text-white sm:text-6xl">
            Work Experience
          </h2>
          ...
          <div className="space-y-12 md:space-y-20">
            {experiences.map((item, index) => {
              ...
              return (
                <div
                  key={item.role}
                  className="relative grid items-start gap-8 pl-10 md:grid-cols-2 md:gap-20 md:pl-0"
                >
                  ...
                  <div className={isLeft ? "md:col-start-1" : "md:col-start-2"}>
                    <article className="rounded-xl border border-white/10 bg-[#050505]/95 p-5 shadow-[0_24px_90px_rgba(0,0,0,0.35)] sm:p-6 md:p-7">
